...
# 論理演算子
数 結果一 は 真 と 真 の且つ と定む。  # AND演算
数 結果二 は 真 と 偽 の又は と定む。  # OR演算
数 結果三 は 真 の非ず と定む。        # NOT演算
```
...
```wz
数 a は 真 と定む。  # 1として扱われる
数 b は 偽 と定む。  # 0として扱われる
```
